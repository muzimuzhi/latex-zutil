...
\hook_gput_code:nnn { test/TEST/begin } { . }
  {
    \int_gset_eq:NN \g__test_group_level_int \currentgrouplevel
...
\hook_gput_code:nnn { test/TEST/end } { . }
  {
    ...
    \test_check_group_level:n { \g__test_group_level_int }
    % log error counts
    \test_add_expandable_errors_cnt:
...
\cs_new:Npn \__test_PASSED:
  {
    \int_compare:nNnTF { \currentgrouplevel } > { \g__test_group_level_int }
