...
\int_new:N \g__zutil_msg_ss_level_int % space-safe nesting level
...
\cs_new_protected:Npn \zutil_msg_space_safe_on:
  {
    \int_if_zero:nT { \g__zutil_msg_ss_level_int }
      {
