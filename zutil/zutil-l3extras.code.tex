\ProvidesExplFile {zutil-l3extras.code.tex} {2025-10-03} {0.5.1}
...
% space safe message declaration
\cs_new_protected:Npn \zutil_msg_new_space_safe:nnnn
  {
    \char_set_catcode_space:N \ %
    \__zutil_msg_new_space_safe_aux:Nnnnn \msg_new:nnnn
  }
\cs_new_protected:Npn \__zutil_msg_new_space_safe_aux:Nnnnn #1#2#3#4#5
  {
    \use:e
      {
        #1
...
\cs_generate_variant:Nn \zutil_msg_new_space_safe:nnnn { nnee }

\cs_new_protected:Npn \zutil_msg_new_space_safe:nnn
  {
    \char_set_catcode_space:N \ %
    \__zutil_msg_new_space_safe_aux:Nnnn \msg_new:nnn
  }
\cs_new_protected:Npn \__zutil_msg_new_space_safe_aux:Nnnn #1#2#3#4
  {
    \use:e
      {
        #1
...
\cs_generate_variant:Nn \zutil_msg_new_space_safe:nnn { nne }

\cs_new_protected:Npn \zutil_msg_set_space_safe:nnnn
  {
    \char_set_catcode_space:N \ %
    \__zutil_msg_new_space_safe_aux:Nnnnn \msg_set:nnnn
  }
\cs_new_protected:Npn \zutil_msg_set_space_safe:nnn
  {
    \char_set_catcode_space:N \ %
    \__zutil_msg_new_space_safe_aux:Nnnn \msg_set:nnn
  }
